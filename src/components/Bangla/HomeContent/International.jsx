...
export default function International() {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/international" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> আন্তর্জাতিক</h2></Link></div>
            <div className="DCatStyle2" id="International">
                <div className="DCatStyle2Top videoIcon">
                    <Link to={"/" + state.Slug + "/" + state.ContentID} onClick={scrollTop}>
                        <picture><img src={process.env.REACT_APP_LAZYL_IMG} data-src={process.env.REACT_APP_IMG_Path + state.ImageSmPath} alt={state.ContentHeading} title={state.ContentHeading} className="img-fluid img100" /></picture>
