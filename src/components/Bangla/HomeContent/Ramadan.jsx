...
export default function Ramadan() {
    ...
    useEffect(() => {
        ...
        // axios //for another way to show ramadan countdown
        //     .get(`https://www.emythmakers.com/namazapi/date/${today}`,
        //         { headers: { Accesstoken: `62497a616353e` } }
        //     )
        //     .then(({ data }) => {
        //         rojaTodayDate = today
        //         rojaTodaySehri = data.prayertimes.SunRise
        //         rojaTodayIftar = data.prayertimes.SunSet
        //         axios
        //             .get(`https://www.emythmakers.com/namazapi/date/${tomorrow}`,
        //                 { headers: { Accesstoken: `62497a616353e` } }
        //             )
        //             .then(({ data }) => {
        //                 rojatomorrowDate = tomorrow
        //                 rojatomorrowSehri = data.prayertimes.SunRise
        //                 rojatomorrowIftar = data.prayertimes.SunSet
        //                 sehriiftarfn(rojaTodayDate, rojaTodaySehri, rojaTodayIftar, rojatomorrowDate, rojatomorrowSehri, rojatomorrowIftar)
        //             });
        //     });
        ...
        <>
            <div className="DWorldCupSection DRamadan">
                <div className="DWorldCupBanner">
                    <img className="img-fluid img100" src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/RamadanBanner.jpg"} width={304} height={99} alt="রমজানের সময় সূচি" title="রমজানের সময় সূচি" />
                </div>
                <div className="DPrayer">
                    <div className="DRamadanTitle">
                        {banglaDateConvetar(arabicDate) + ', ' + banglaDateConvetar(currentDay)}
                    </div>
