...
export default function Feature() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}json/file/generateCategory16.json`)
            .then(({ data }) => {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/feature" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> ফিচার </h2></Link></div>
