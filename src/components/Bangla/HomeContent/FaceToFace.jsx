...
export default function FaceToFace() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}json/file/generateCategory25.json`)
            .then(({ data }) => {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/interview" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> মুখোমুখি </h2></Link></div>
            <div className="DCatStyle1List" id="FaceToFace">
