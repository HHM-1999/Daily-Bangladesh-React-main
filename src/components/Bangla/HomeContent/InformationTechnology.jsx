...
export default function InformationTechnology() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}json/file/generateCategory29.json`)
            .then(({ data }) => {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/information-technology" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> তথ্যপ্রযুক্তি</h2></Link></div>
