...
export default function Education() {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/education" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> শিক্ষাঙ্গন</h2></Link></div>
