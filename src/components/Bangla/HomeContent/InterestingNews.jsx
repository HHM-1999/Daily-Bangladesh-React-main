...
export default function InterestingNews() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}json/file/generateCategory22.json`)
            .then(({ data }) => {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/interesting-news" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> মজার খবর</h2></Link></div>
