        ...
        <>
                <div className="DPrayer">
                    <div className="DPrayersBanner">
                        <Link to="/"><img className="img-fluid img100" src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/namaz.png"} width={304} height={59} alt="Namaz" title="Namaz" /></Link>
                    </div>
