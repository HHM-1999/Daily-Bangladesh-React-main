...
export default function ArtAndLiterature() {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/art-and-culture" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> শিল্প-সাহিত্য</h2></Link></div>
