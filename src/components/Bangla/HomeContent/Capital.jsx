...
export default function Capital() {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/capital" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> রাজধানী</h2></Link></div>
                            ...
                            <Link to={"/" + nc.Slug + "/" + nc.ContentID} onClick={scrollTop}>
                                <div className="row">
                                    ...
                                    <div className="col-lg-8 col-sm-9 col-7">
                                        <div className="Desc">
                                            <h2 className="Title SMTitle">{nc.ContentHeading}</h2>
                                        </div>
                                    </div>
                                </div>
                            </Link>
