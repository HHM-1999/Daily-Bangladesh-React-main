...
export default function Health() {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/health-and-medical" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> স্বাস্থ্য ও চিকিৎসা </h2></Link></div>
