                ...
                <div className="DWorldCupBanner">
                    <Link to="/tags/সালতামামি ২০২৩" onClick={scrollTop}>
                        {window.innerWidth > 990 ?
                            <img className="img-fluid img100" src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/saltamami.jpg"} width={305} height={100} alt="সালতামামি" title="সালতামামি" /> :
                            <img className="img-fluid img100" src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/saltamami.jpg"} width={305} height={100} alt="সালতামামি" title="সালতামামি" />}
                    </Link>
                </div>
