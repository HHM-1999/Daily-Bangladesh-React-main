...
export default function BookFair() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}json/file/generateCategory32.json`)
            .then(({ data }) => {
        ...
        <>
            {live ?
                ...
                <div className="DOpinionSec">
                    <div className="DOpinionBanner">
                        <Link to="/book-fair"><img className="img-fluid img100" src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/boimela-banner.jpg"} width={304} height={40} alt="বইমেলা" title="বইমেলা" /></Link>
                    </div>
