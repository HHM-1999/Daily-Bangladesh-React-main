...
export default function Politics() {
    ...
    return (
        <>
            <div className="SPSecTitle"><Link to="/bd-politics" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> রাজনীতি</h2></Link></div>
