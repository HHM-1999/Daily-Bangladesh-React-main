...
function OnPageLoad() {
    ChangeKeyboarLayoutStatus(); ChangeConverterStatus(); var myFld = document.getElementById(ID); var unicodefontLabel = document.getElementById("unicodefont"); if (IE) { unicodefontLabel.innerHTML = "Download the unicode font from <a href=SutonnyBanglaOMJ.ttf>here</a>."; myFld.style.fontFamily = "SutonnyBanglaOMJ"; }
    else { unicodefontLabel.innerHTML = "Download the unicode font from <a href=SolaimanLipi_29-05-06.ttf>here</a>."; myFld.style.fontFamily = "SolaimanLipi"; }
