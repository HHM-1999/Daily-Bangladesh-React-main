...
var sel;
var Insert;
var IsBanglaSoroborno;
var IsBanglaDigit;
var IsSpace;
var IsBanglaBanjonborno;
var IsBanglaKar;
var MapSorbornoToKar;
var IsBanglaPostKar;
var MapKarToSorborno;
var IsBanglaNukta;
var IsBanglaFola;
var IsBanglaPreKar;
var ChangeKeyboarLayoutStatus;
...
function KarModification(field, CUni) {
    ...
    else if (CUni === "র্") { len = LC_STRING.length; LC_STRING = CUni + LC_STRING; RemoveNInsert(field, LC_STRING + LC_KAR, len + LC_KAR.length); }
...
function RefModification(field) {
    var len = 1; var kar = ""; var str = ""; var halant_found = true; var CH = ""; field.focus(); while (true) {
        if (document.selection) {
            ...
            if (startPos < 0) { CH = ""; len--; startPos = field.selectionStart - len; break; }
...
function IsSomewhereinPhoneticModifierCharaceter(CUni) {
    if (CUni === 'হ' || CUni === 'গ' || CUni === 'ঘ' || CUni === 'ণ' || CUni === 'ঃ' || CUni === 'ট' || CUni === 'ো' || CUni === 'ই' || CUni === 'ি' || CUni === 'উ' || CUni === 'ু' || CUni === 'র' || CUni === 'ড়')
        return true; return false;
}
function GetSomewhereinPhoneticModifiedCharaceter(CUni) { var CMod = CUni; if (LCUNI === 'ক' && CUni === 'হ') CMod = 'খ'; else if (LCUNI === 'গ' && CUni === 'হ') CMod = 'ঘ'; else if (LCUNI === 'চ' && CUni === 'হ') CMod = 'চ'; else if (LCUNI === 'জ' && CUni === 'হ') CMod = 'ঝ'; else if (LCUNI === 'ট' && CUni === 'হ') CMod = 'ঠ'; else if (LCUNI === 'ড' && CUni === 'হ') CMod = 'ঢ'; else if (LCUNI === 'ত' && CUni === 'হ') CMod = 'থ'; else if (LCUNI === 'দ' && CUni === 'হ') CMod = 'ধ'; else if (LCUNI === 'প' && CUni === 'হ') CMod = 'ফ'; else if (LCUNI === 'ব' && CUni === 'হ') CMod = 'ভ'; else if (LCUNI === 'স' && CUni === 'হ') CMod = 'শ'; else if (LCUNI === 'ড়' && CUni === 'হ') CMod = 'ঢ়'; else if (LCUNI === 'ণ' && CUni === 'গ') CMod = 'ঙ'; else if (LCUNI === 'ন' && CUni === 'গ') CMod = 'ং'; else if (LCUNI === 'ণ' && CUni === 'ঘ') CMod = 'ঞ'; else if (LCUNI === 'ণ' && CUni === 'ণ') CMod = 'ঁ'; else if (LCUNI === 'ঃ' && CUni === 'ঃ') CMod = 'ঃ'; else if (LCUNI === 'ট' && CUni === 'ট') CMod = 'ৎ'; else if (LCUNI === 'া' && CUni === 'ো') CMod = 'অ'; else if (LCUNI === 'ি' && CUni === 'ি') CMod = 'ী'; else if (LCUNI === 'ই' && CUni === 'ই') CMod = 'ঈ'; else if (LCUNI === 'ু' && CUni === 'ু') CMod = 'ূ'; else if (LCUNI === 'উ' && CUni === 'উ') CMod = 'ঊ'; else if (LCUNI === 'ও' && CUni === 'ই') CMod = 'ঐ'; else if (LCUNI === 'ো' && CUni === 'ি') CMod = 'ৈ'; else if (LCUNI === 'ও' && CUni === 'উ') CMod = 'ঔ'; else if (LCUNI === 'ো' && CUni === 'ু') CMod = 'ৌ'; else if (LCUNI === 'ৃ' && CUni === 'র') CMod = 'ৃ'; else if (LCUNI === 'ঋ' && CUni === 'ড়') CMod = 'ঋ'; return CMod; }
...
function GetAvroPhoneticModifiedCharaceter(CUni) {
    var CMod = CUni; if (CUni !== 'হ' && Avro_Cha_Flag === true)
        ...
        else if (LCUNI === 'জ' && CUni === 'হ') CMod = 'ঝ'; else if (LCUNI === 'ট' && CUni === 'হ') CMod = 'ঠ'; else if (LCUNI === 'ড' && CUni === 'হ') CMod = 'ঢ'; else if (LCUNI === 'ত' && CUni === 'হ') CMod = 'থ'; else if (LCUNI === 'দ' && CUni === 'হ') CMod = 'ধ'; else if (LCUNI === 'প' && CUni === 'হ') CMod = 'ফ'; else if (LCUNI === 'ব' && CUni === 'হ') CMod = 'ভ'; else if (LCUNI === 'স' && CUni === 'হ') CMod = 'শ'; else if (LCUNI === 'শ' && CUni === 'হ') CMod = 'ষ'; else if (LCUNI === 'ড়' && CUni === 'হ') CMod = 'ঢ়'; else if (LCUNI === 'ণ' && CUni === 'গ') CMod = 'ঙ'; else if (LCUNI === 'ন' && CUni === 'গ') CMod = 'ং'; else if (LCUNI === 'ণ' && CUni === 'ঘ') CMod = 'ঞ'; else if (LCUNI === 'ঃ' && CUni === 'ঃ') CMod = 'ঃ'; else if (LCUNI === 'ট' && CUni === 'ট') CMod = 'ৎ'; else if (LCUNI === 'া' && CUni === 'ো') CMod = 'অ'; else if (LCUNI === 'ি' && CUni === 'ি') CMod = 'ী'; else if (LCUNI === 'ু' && CUni === 'ু') CMod = 'ূ'; else if (LCUNI === 'উ' && CUni === 'উ') CMod = 'ঊ'; else if (LCUNI === 'ও' && CUni === 'ই') CMod = 'ঐ'; else if (LCUNI === 'ো' && CUni === 'ি') CMod = 'ৈ'; else if (LCUNI === 'ও' && CUni === 'উ') CMod = 'ঔ'; else if (LCUNI === 'ো' && CUni === 'ু') CMod = 'ৌ'; else if (LCUNI === 'ৃ' && CUni === 'র') CMod = 'ৃ'; else if (LCUNI === 'ঋ' && CUni === 'ড়') CMod = 'ঋ'; else if ((LCUNI === 'র' || LCUNI === 'ড়') && IsBanglaBanjonborno(CUni)) CMod = CUni; else if (CUni === 'ঁ')
...
function ProcessCharacter(field, C, K, CUni) {
    ...
    if (IsBanglaPostKar(CUni))
        ...
        CUni2 = GetAvroPhoneticModifiedCharaceter(CUni); if (CUni2 !== CUni) {
...
function KeyBoardDown(ev) {
    var field; if (IE)
        ...
        field = ev.target; var K = (window.event) ? ev.keyCode : ev.which; var C = String.fromCharCode(K); if (K === 27)
...
function KeyBoardPress(ev) {
    var field; if (IE)
        ...
        field = ev.target; var K = (window.event) ? ev.keyCode : ev.which; var C = String.fromCharCode(K); if (ev.altKey && ev.ctrlKey && (C === 'E' || C === 'e'))
    ...
    var CUni = ""; CUni = MapUnicodeCharacter(C); if (CUni === null)
        ...
        ev.keyCode = 0; LC = C; if (K > 29) return false; return true;
}
export {
    KeyBoardDown,
    KeyBoardPress
