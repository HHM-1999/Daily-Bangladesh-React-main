...
export default function Sports() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL_EN}json/file/generateCategory7.json`)
            .then(({ data }) => {
    ...
    return (
        <>
            <div className="SPSecTitle En"><Link to="/english/sports" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> Sports</h2></Link></div>
            <div className="DSports">
                <div className="row">
                    <div className="col-lg-6 col-sm-12 col-12">
                        <div className="DSportsTopBlock">
                            <div className="DSportsTop En">
                    ...
                    <div className="col-lg-3 col-sm-12 col-12 order-lg-first">
                        <div className="DSportsTop2">
                            {state2.map((nc) => {
                                return (
                                    <div className="DSportsTop2List En" key={nc.ContentID}>
                                    ...
                                    <div className="DSportsTop2List En" key={nc.ContentID}>
                                        <Link to={"/english/" + nc.Slug + "/" + nc.ContentID} onClick={scrollTop}>
                                            <div className="row">
                                                ...
                                                <div className="col-lg-7 col-sm-8 col-7 order-lg-first">
                                                    <div className="Des8">
                                                        <h2 className="Title SMTitle2">{nc.ContentHeading}</h2>
                                                    </div>
                                                </div>
