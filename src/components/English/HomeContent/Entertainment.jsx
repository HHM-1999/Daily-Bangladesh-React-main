...
export default function Entertainment() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL_EN}json/file/generateCategory9.json`)
            .then(({ data }) => {
    ...
    return (
        <>
            <div className="SPSecTitle En"><Link to="/english/entertainment" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" />Entertainment</h2></Link></div>
            <div className="DEntertainment En">
                <div className="row">
                                    ...
                                    <div className="DEnterTop2List" key={nc.ContentID}>
                                        <Link to={"/english/" + nc.Slug + "/" + nc.ContentID} onClick={scrollTop}>
                                            <div className="row">
                                                ...
                                                <div className="col-lg-8 col-sm-8 col-7 order-lg-first">
                                                    <div className="Desc">
                                                        <h4 className="Title SMTitle fw-bold">{nc.ContentHeading}</h4>
                                                        <div className="Brief"><p dangerouslySetInnerHTML={{ __html: nc.ContentBrief }}></p></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </Link>
