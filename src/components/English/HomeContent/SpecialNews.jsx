...
export default function SpecialNews() {
    ...
    return (
        <>
            <div className="SPSecTitle En"><Link to="/english/feature" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> Special News </h2></Link></div>
