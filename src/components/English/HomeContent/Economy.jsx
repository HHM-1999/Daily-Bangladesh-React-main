...
export default function Economy() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL_EN}json/file/generateCategory6.json`)
            .then(({ data }) => {
    ...
    return (
        <>
            <div className="SPSecTitle En">
                <Link to="/english/economy" onClick={scrollTop}>
                    <h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> Economy </h2>
                </Link>
            </div>
            <div className="DCatStyle1List En">
                <div className="DCatStyle1Top">
                    <div className="thumbnail videoIcon">
                        <Link to={"/english/" + economy.Slug + "/" + economy.ContentID} onClick={scrollTop}>
                            <picture>
                                <img src={process.env.REACT_APP_LAZYL_IMG_En} data-src={process.env.REACT_APP_IMG_Path + economy.ImageSmPath} alt={economy.ContentHeading} title={economy.ContentHeading} className="img-fluid img100" />
                            </picture>
