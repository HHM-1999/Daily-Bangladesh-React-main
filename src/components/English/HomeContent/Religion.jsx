...
export default function Religion() {
    ...
    useEffect(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL_EN}json/file/generateCategory12.json`)
            .then(({ data }) => {
    ...
    return (
        <>
            <div className="SPSecTitle En"><Link to="/english/religion" onClick={scrollTop}><h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> Religion </h2></Link></div>
