...
export default function DistrictSlug() {
    let { divisionSlugEn, dristrictSlugEn } = useParams();
    ...
    useEffect(() => {
        ...
        showMore = true
        axios
            .get(`${process.env.REACT_APP_API_URL_EN}district-division-content/${divisionSlugEn}/${dristrictSlugEn}`)
            .then(({ data }) => {
                if (data.districtContent.content.length !== 0) {
                    ...
                    if (data.districtContent.content.length < LeadNewsLimit) {
                        ...
                        axios
                            .post(`${process.env.REACT_APP_API_URL_EN}inner-district-content-more`, formData)
                            .then(({ data }) => {
    ...
    }, [divisionSlugEn, dristrictSlugEn])
            ...
            {dristrictName ?
                <main>
                    <div className="container">
                        ...
                        <DocumentTitle title={dristrictName.DistrictName} />
                        <h2 className="mvp-feat1-pop-head DTitle En"><Link to={+ "/"} onClick={scrollTop}><span className="mvp-feat1-pop-head">{dristrictName.DistrictName}</span></Link></h2>
                        <div className="row">
                                            ...
                                            return (
                                                <div className="col-lg-6 col-sm-12" key={nc.ContentID}>
                                                    <div className="Division-panel">
                                                        <div className="DistrictListNews En">
                                                            <Link to={"/english/country/" + nc.ContentID} onClick={scrollTop}>
                                                                <div className="row">
                                                                    ...
                                                                    <div className="col-lg-7 col-sm-8 col-7">
                                                                        ...
                                                                        <span className="DateTime"> {format(new Date(nc.create_date), 'EEEE, dd MMMM yyyy, HH:mm')}</span>
                                                                    </div>
                                                                </div>
                                                            </Link>
                                                        </div>
