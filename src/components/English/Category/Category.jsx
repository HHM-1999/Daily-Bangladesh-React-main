...
import CatLdjsonEn from './CatLdjsonEn';
    ...
    useEffect(() => {
        ...
        axios
            ...
            .then(({ data }) => {
                ...
                axios
                    .get(`${process.env.REACT_APP_API_URL_EN}inner-category-content/${catID}/${leadLimit}`)
                    .then(({ data }) => {
                        if (data.inner_category_content) {
                            ...
                            axios
                                .post(`${process.env.REACT_APP_API_URL_EN}inner-category-content-more`, formData)
                                .then(({ data }) => {
                                    if (data.data) {
                ...
                // offset = leadLimit
                // axios
                //     .get(`${process.env.REACT_APP_API_URL_EN}inner-category-content-more/${catID}/${limit}/${offset}`)
                //     .then(({ data }) => {
            ...
            {catName ?
                <main>
                    <div className="container">
                        <CatLdjsonEn CatNames={catName.CategoryName} CatNameSlug={catName.Slug} />
                        <DocumentTitle title={catName && catName.CategoryName} />
                        <h2 className="mvp-feat1-pop-head DTitle En"><Link to={"/english/" + catName.Slug} onClick={scrollTop}><span className="mvp-feat1-pop-head">{catName.CategoryName || <Skeleton count={1} />}</span></Link></h2>
                        <div className="row">
                            <div className="col-lg-9 col-sm-12">
                                {catSlugEn === 'country' && <DivisionDistrictNameEn />}
                                <div className="row">
                                    <div className="col-lg-8 col-12 d-flex">
                                        {isSkeletonLoading ?
                                            <div className="DCatLeadTop En" style={{ width: '100%' }}>
                                                <Link to={"/"}>
                                            ...
                                            :
                                            <div className="DCatLeadTop En">
                                                <Link to={"/english/" + catSlugEn + "/" + catLeadNews1.ContentID} onClick={scrollTop}>
                                                    <div className="row">
                                                        <div className="col-lg-8 col-12 videoIcon">
                                                            <picture><img src={process.env.REACT_APP_LAZYL_IMG_En} data-src={process.env.REACT_APP_IMG_Path + catLeadNews1.ImageBgPath} alt={catLeadNews1.ContentHeading} title={catLeadNews1.ContentHeading} /></picture>
                                                            {catLeadNews1.ShowVideo === 1 || catLeadNews1.VideoID !== null ? <span className="play-btn"><i className="fas fa-play"></i></span> : ""}
                                                        </div>
                                                        <div className="col-lg-4 col-12">
                                                            <div className="Desc">
                                                                <h1 className="Title BGTitle">{catLeadNews1.ContentHeading}</h1>
                                                                <div className="Brief">
                                                                    <p dangerouslySetInnerHTML={{ __html: catLeadNews1.ContentBrief }}></p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="col-lg-4 col-12 d-flex">
                                        {isSkeletonLoading ?
                                            <div className="DCatTop2 En align-self-stretch" >
                                                <Link to={"/"}>
                                                    {window.innerWidth > 991 ?
                                                        <div className="row">
                                            ...
                                            <div className="DCatTop2 En align-self-stretch">
                                                <Link to={"/english/" + catSlugEn + "/" + catLeadNews2.ContentID} onClick={scrollTop}>
                                                    <div className="row">
                                                        <div className="col-lg-12 col-sm-4 col-5 videoIcon">
                                                            <picture><img src={process.env.REACT_APP_LAZYL_IMG_En} data-src={process.env.REACT_APP_IMG_Path + catLeadNews2.ImageSmPath} alt={catLeadNews2.ContentHeading} title={catLeadNews2.ContentHeading} /></picture>
                                                            {catLeadNews2.ShowVideo === 1 || catLeadNews2.VideoID !== null ? <span className="play-btn"><i className="fas fa-play"></i></span> : ""}
                                                        </div>
                                        ...
                                        {isSkeletonLoading ? <>
                                            {Array(3).fill("").map((nc) => (
                                                <div className="col-lg-4 col-12 d-flex" key={nc.ContentID}>
                                                    <div className="DCatTop3tList En align-self-stretch">
                                                        <Link to={"/"}>
                                                            {window.innerWidth > 991 ?
                                                                <div className="row">
                                                                    <div className="col-lg-12 col-sm-3 col-5 videoIcon">
                                            ...
                                            {catLeadNews3 && catLeadNews3.map((nc) => {
                                                return (
                                                    <div className="col-lg-4 col-12 d-flex" key={nc.ContentID}>
                                                        <div className="DCatTop3tList En align-self-stretch">
                                                            <Link to={"/english/" + catSlugEn + "/" + nc.ContentID} onClick={scrollTop}>
                                                                <div className="row">
                                                                    <div className="col-lg-12 col-sm-4 col-5 videoIcon">
                                                                        <picture><img src={process.env.REACT_APP_LAZYL_IMG_En} data-src={process.env.REACT_APP_IMG_Path + nc.ImageSmPath} alt={nc.ContentHeading} title={nc.ContentHeading} /></picture>
                        ...
                        <div className="row">
                                ...
                                <div className="row">
                                    <div className="col-lg-12 col-sm-12">
                                        <div className="SPSecTitle">
                                            <h2><img src={process.env.REACT_APP_FONT_DOMAIN_URL + "media/common/Sign.png"} width={16} height={16} alt="Sign" title="Sign" /> All news of {catName.CategoryName} </h2>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            return (
                                                <>
                                                    <div className="col-lg-6 col-12 d-flex" key={nc.ContentID}>
                                                        <div className="DCatNewsList En align-self-stretch">
                                                            <Link to={"/english/" + catSlugEn + "/" + nc.ContentID} onClick={scrollTop}>
                                                                <div className="row">
                            ...
                            <div className="col-lg-3 col-sm-12">
                                <CatMostReadable catID={catName.CategoryID} />
                                <Squire01 />
                            </div>
                        </div>
                    </div>
